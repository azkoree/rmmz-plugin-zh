 ...
 * @text 显示/消去事件
 * @desc 指定通知在画面上滚动出现/消失的时间，1秒 = 60帧。
 * @parent base
 * @type number
 * @min 0
 * @decimals 0
 ...
 * @param baseViewTime
 * @text 显示时间
 * @desc 指定通知的显示时间（1秒 = 60帧）。为0时不会消失，直到切换场景。
 * @parent base
 * @type number
 * @min 0
 * @decimals 0
 ...
 * @text 有效开关
 * @desc 打开此处设置的开关时才能显示通知信息。此处不设置开关则总是通知。
 * @parent advanced
 * @type switch
 * @default 0
 *
 ...
 * @text 追加显示通知的场景
 * @desc 在地图之外的场景显示通知。请指定场景名。（例：Scene_Battle）
 * @parent advanced
 * @type string[]
 * @default []
 *
 ...
 * @text 改变场景仍然显示信息
 * @desc 【危险：启用可能导致故障，取决于环境】改变场景后，不会清除所有消息。
 * @parent advanced
 * @type boolean
 * @on 保持显示（危险）
 * @off 不保持显示（安全）
 ...
 * @arg message
 * @text 信息
 * @desc 指定通知显示的文本。可使用事件命令显示文本中的部分控制符。

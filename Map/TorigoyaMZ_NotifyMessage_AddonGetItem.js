...
/*:zh
 * @target MZ
 * @plugindesc 通知信息追加：显示道具获取 (v.1.3.0)
 * @version 1.3.0
 ...
 * @text 金钱获得信息
 * @desc 设定获得金钱时显示的信息。（\gold : 获得金额）
 * @parent base
 * @type string
 * @default 获得了 \gold\c[4]\G\c[0] ！
 *
 * @param baseGainMoneyIcon
 * @text 金钱获取图标
 * @desc 设定获得金钱时显示的图标。0不显示图标。
 * @parent base
 * @type number
 * @decimals 0
 * @default 0

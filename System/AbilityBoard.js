 ...
 * @off 不编组
 * @default false
 * @desc 设定是否与父能力和连接的能力进行编组
 *       如果进行编组，获取所有能力后才开放获取
 *
 * @param nextAbility
 * @text 移动目标能力
 * @type struct<nextAbility>
 * @desc 设定按下按键时移动到的目标能力
 *
 * @param effectType
 * @text 能力类型
 * @type select
